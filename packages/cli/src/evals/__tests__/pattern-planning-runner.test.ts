...
type PatternTestOptions = PatternPlanningRunnerOptions & {
  modelClient: StubModelClient;
  scorer: StubAgentEvalsScorer;
};
type PatternTestDependencies = Pick<
  PatternTestOptions,
  "modelClient" | "scorer"
>;
...
class InMemoryPatternRunner extends PatternPlanningRunner {
  ...
  private readonly _dependencies: PatternTestDependencies;
...
function executeCaseWithStubs(
  dependencies: PatternTestDependencies,
  evalCase: EvalCase,
  modelId: string,
  rubrics: EvalRubric[],
