...
import type { IdGenerator, PiAdapterLogger } from "./types.js";
 ...
 /** A bounded task/context object, echoed at multiple layers (Pi adapter contract): tool parsing, control schema, this controller, and the RPC prompt send in `rpc-child.ts`. */
