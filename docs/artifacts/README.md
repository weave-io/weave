...
- [`judge-bakeoff-2026-09-23.md`](judge-bakeoff-2026-09-23.md) — Spec 37 task 16.3: acceptance check for TypeSafe Jev as the eval judge against human pass/fail labels, with Sonnet 5 as a reference; method, question design and acceptance rule, with results pending labels.
