...
- [ ] 2. Define protocol, event, and persistence schemas
...
- [ ] 3. Add generic opaque adapter settings to core and layered config
...
- [ ] 4. Validate Pi `child_inspection` settings and activation choices
...
- [ ] 5. Implement the private history filesystem port and store
