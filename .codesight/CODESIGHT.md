...
> 0 routes | 0 models | 0 components | 281 lib files | 40 env vars | 10 middleware | 9 events | 0% test coverage
> **Token savings:** this file is ~29,800 tokens. Without it, AI exploration would cost ~91,700 tokens. **Saves ~61,900 tokens per conversation.**
> **Last scanned:** 2026-08-13 00:06 — re-run after significant changes
