...
- [`judge-bakeoff-2026-09-23.md`](judge-bakeoff-2026-09-23.md) — Spec 37 task 16.3: TypeSafe Jev against Sonnet 5 as the eval judge, measured against human pass/fail labels; method, question design and decision rule, with results pending labels.
