...
> 0 routes | 0 models | 0 components | 90 lib files | 4 env vars | 5 middleware | 0% test coverage
> **Token savings:** this file is ~7.300 tokens. Without it, AI exploration would cost ~34.300 tokens. **Saves ~27.000 tokens per conversation.**
> **Last scanned:** 2026-06-09 05:19 — re-run after significant changes
