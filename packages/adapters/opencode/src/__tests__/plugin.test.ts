...
describe("WeavePlugin — config-hook agent materialization", () => {
  ...
  it("sets default_agent to Loom when Loom is injected", async () => {
...
describe("WeavePlugin — slash command registration", () => {
  it("registers both commands after injecting Tapestry", async () => {
  ...
  it("skips one command when its name collides", async () => {
