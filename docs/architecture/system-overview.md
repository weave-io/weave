...
**Related:** [Product Vision](product-vision.md) · [Adapter Boundary](adapter-boundary.md) · [Config Loading](../reference/configuration.md) · [Prompt Composition](../reference/prompts.md) · [Model Resolution](../reference/models.md) · [Agent Surface Patterns](agent-surfaces.md) · [Runtime Store](../reference/runtime.md)
...
Project-level prompt overrides and category definitions remain config-layer concerns; the engine consumes them as normalized input without special-casing their origin.
