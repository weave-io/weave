...
> 0 routes | 0 models | 0 components | 48 lib files | 2 env vars | 0 middleware | 0% test coverage
> **Token savings:** this file is ~4,000 tokens. Without it, AI exploration would cost ~21,800 tokens. **Saves ~17,800 tokens per conversation.**
> **Last scanned:** 2026-05-20 19:07 — re-run after significant changes
