...
2. 16.3 → 16.4, the judge. 16.3 is done (#223). 16.4a is done (#233): with the missed checks made explicit in the rubrics, the re-run accepted Jev, so 16.4b wires Jev in as the judge.
...
## 16. Truthful scores (G9) — PR: #221 (16.1), #220 (16.2), #223 (16.3), #233 (16.4a), #228 (16.5)
