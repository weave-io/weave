...
> **Last scanned:** 2026-05-26 19:23 — re-run after significant changes
...
- `packages/adapters/opencode/src/sdk-types.ts` — imported by **6** files
...
- `packages/adapters/opencode/src/sdk-types.ts` ← `packages/adapters/opencode/src/__tests__/adapter.test.ts`, `packages/adapters/opencode/src/__tests__/run-workflow.test.ts`, `packages/adapters/opencode/src/index.ts`, `packages/adapters/opencode/src/reconcile-agent.ts`, `packages/adapters/opencode/src/tool-policy-mapping.ts` +1 more
