...
- [x] 4. Update Spec 15 to reflect partial-by-default
...
- [x] 8. Scaffold `@weave/adapter-opencode` package skeleton with `@opencode-ai/sdk` dependency
...
- [x] 9. Implement `OpenCodeAdapter.spawnSubagent` translation against real SDK types
...
- [x] 10. Wire workflow execution end-to-end in the adapter
...
- [x] 13. P1-A: Merge logic for workflow extension
...
- [x] 14. P1-A: Document workflow extension migration and fill validation artefact
...
- [x] 18. P1-C: Implement `PlanStateProvider` and remove `Bun.file` from `execution-lifecycle.ts`
  **What**:
...
- [x] 19. P1-C: Wire `BunFilesystemPlanStateProvider` into the reference adapter
...
- [x] 20. P2-A: Outright deletion of `registerHook`, `loadSkill`, `HookConfig`, `SkillConfig`
...
- [x] 21. P2: Run full verification matrix
...
- [x] 22. P2: Living-documentation sweep and adapter-readiness status report
