...
2. 16.3 → 16.4, the judge. 16.3 is done (#223): Jev was rejected, so 16.4 takes the fallback, a chat-model judge kept out of the matrix.
...
## 16. Truthful scores (G9) — PR: #221 (16.1), #220 (16.2), #223 (16.3), #228 (16.5)
