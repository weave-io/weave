...
/** Build a full passing contract (all 22 capabilities native). */
...
describe("SafeAdapterInitInput: shape and constraints", () => {
  ...
  it("accepts a full input with all capabilities and probes", () => {
    ...
    expect(input.capabilityContract.capabilities).toHaveLength(22);
    expect(input.probeResults).toHaveLength(22);
  });
