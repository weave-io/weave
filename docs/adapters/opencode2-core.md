...
[package separation decision](../adr/0010-opencode2-independent-adapter.md).
...
README](../../packages/adapters/opencode2/README.md)
...
{
  "plugins": [
    "@weaveio/weave-adapter-opencode2@<exact-version>",
  ],
}
```
...
```jsonc
{
  "plugins": [
    {
      "package": "@weaveio/weave-adapter-opencode2@<exact-version>",
      "options": {
        "projectConfig": true,
        "defaultAgent": "loom",
...
**Accepted host limit:** OpenCode `0.0.0-beta-19151` does not expose the native
