...
```
$ bun run --filter '@weaveio/weave-core' build && bun run --filter '@weaveio/weave-engine' --filter '@weaveio/weave-config' build && bun run --filter '@weaveio/weave-cli' build && bun run --filter '@weaveio/weave-adapter-*' build
@weaveio/weave-core build: Bundled 88 modules in 7ms
@weaveio/weave-core build:   index.js  0.58 MB  (entry point)
@weaveio/weave-core build: Exited with code 0
@weaveio/weave-engine build: Bundled 122 modules in 8ms
@weaveio/weave-engine build:   index.js  0.73 MB  (entry point)
@weaveio/weave-engine build: Exited with code 0
@weaveio/weave-config build: Bundled 125 modules in 9ms
@weaveio/weave-config build:   index.js  0.72 MB  (entry point)
@weaveio/weave-config build: Exited with code 0
@weaveio/weave-cli build: Bundled 151 modules in 11ms
@weaveio/weave-cli build:   index.js  0.89 MB  (entry point)
@weaveio/weave-cli build:   main.js   0.89 MB  (entry point)
