# ADR 0010: OpenCode V2 Adapter as a Separate Independent Package with Transform-Based Reconciliation

**Status**: Accepted
**Date**: 2026-09-05
**Related**: [Spec 34: OpenCode V2 Adapter (Independent Package)](../specs/34-spec-opencode2-adapter/34-spec-opencode2-adapter.md) · [Adapter Boundary](../adapter-boundary.md) (read-only reference; no changes proposed) · [Feasibility Decision](../artifacts/opencode2-feasibility/DECISION.md) · [Plan: opencode2-adapter](../../.weave/plans/opencode2-adapter.md)
...
This model is fully specified in [Spec 34, Section 5](../specs/34-spec-opencode2-adapter/34-spec-opencode2-adapter.md#5-transform-based-reconciliation-semantics).
